...
//	ST7735_Unselect();
//	hspi1.Instance->CR1 &= 0xFFBF;					// �ر�SPI
//   hspi1.Instance->CR1 |= 0x0800;	            // �л���16λ���ݸ�ʽ
//   hspi1.Instance->CR1 |= 0x0040;					// ʹ��SPI
//	
//	ST7735_Select();
//	HAL_GPIO_WritePin(ST7735_DC_GPIO_Port, ST7735_DC_Pin, GPIO_PIN_SET);     // ����ָ��ѡ�� ��������ߵ�ƽ���������δ��� ����	
...
////	HAL_SPI_Transmit(&ST7735_SPI_PORT, (uint8_t *)DataBuff, width* height*2, 1000) ;
//	for(uint16_t i=0;i<160*128;i++)				
//	{

//		hspi1.Instance->DR = color;
//	   while( (hspi1.Instance->SR & 0x0002) == 0);		// �ȴ����ͻ��������
//	}
//	while( (hspi1.Instance->SR & 0x0080) != RESET);	//	�ȴ�ͨ�����	
//		
//	ST7735_Unselect();
//	hspi1.Instance->CR1 &= 0xFFBF;					// �ر�SPI
//   hspi1.Instance->CR1 |= 0xF7FF;	            // �л���8λ���ݸ�ʽ
//   hspi1.Instance->CR1 |= 0x0040;					// ʹ��SPI
