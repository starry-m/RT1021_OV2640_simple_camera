...
#define LCD_LPSPI_MASTER_PCS_FOR_TRANSFER (kLPSPI_MasterPcs0)
#define LCD_LPSPI_MASTER_BASEADDR   (LPSPI4)
...
//#define ST7735_HEIGHT 160 
//#define ST7735_ROTATION (ST7735_MADCTL_MY | ST7735_MADCTL_ML | ST7735_MADCTL_BGR)
