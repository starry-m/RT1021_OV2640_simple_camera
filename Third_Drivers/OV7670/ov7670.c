...
//	}
	...
	while (LPI2C_MasterGetStatusFlags(LPI2C3_PERIPHERAL) & kLPI2C_MasterNackDetectFlag)
		;
	reVal = LPI2C_MasterSend(LPI2C3_PERIPHERAL, tt, 2);
	if (reVal != kStatus_Success)
		return kStatus_Fail;

	reVal = LPI2C_MasterStop(LPI2C3_PERIPHERAL);
	if (reVal != kStatus_Success)
		return kStatus_Fail;
...
//	}
    ...
    reVal = LPI2C_MasterSend(LPI2C3_PERIPHERAL, &regAddr, 1);
    if (reVal != kStatus_Success)
        return kStatus_Fail;
    ...
    reVal = LPI2C_MasterReceive(LPI2C3_PERIPHERAL, pData, 1);
    if (reVal != kStatus_Success)
        return kStatus_Fail;
